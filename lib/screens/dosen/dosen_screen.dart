...
// Widget utama untuk menampilkan daftar dosen
class DosenScreen extends ConsumerWidget {
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  // Saat ini fitur update belum diimplementasikan
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Fitur update belum tersedia'),
              ...
              ElevatedButton.icon(
                onPressed: () async {
                  try {
                    ...
                    await ref.read(DosenProvider.notifier).deleteDosen(id);
  ...
  // 🔹 Tampilan utama layar daftar dosen
  @override
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        // Nama dosen sebagai judul utama
                        title: Text(
                          data["nama"],
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),

                        // nidn dan Prodi ditampilkan di bawah nama
                        subtitle: Text(
                          'Nidn: ${data["nidn"]}\nProdi: ${data["prodi"]}',
                        ),
